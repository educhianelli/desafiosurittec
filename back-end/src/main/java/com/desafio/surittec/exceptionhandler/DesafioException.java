package com.desafio.surittec.exceptionhandler;
...
@ControllerAdvice
public class DesafioException extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object>handleEmptyDataAccessException(EmptyResultDataAccessException ex, WebRequest request){
		...
		List<Erro>erros=Arrays.asList(new Erro(msgDev,msgUser));
	...
	private List<Erro> listaErros(BindingResult bindingResult) {
		...
		for(FieldError field : bindingResult.getFieldErrors() ) {
			...
			erros.add(new Erro(msgDev,msgUser));
		}
		return erros;
	...
	public static class Erro {
		...
		public Erro(String msgDev, String msgUser) {
			this.msgDev = msgDev;
